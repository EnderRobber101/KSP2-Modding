...
public class MyModPlugin : BaseSpaceWarpPlugin
{
    ...
    // AppBar button IDs
    private const string ToolbarFlightButtonID = "BTN-MyModFlight";
    private const string ToolbarOabButtonID = "BTN-MyModOAB";

    // Singleton instance of the plugin class
    public static MyModPlugin Instance { get; set; }
    //Addressables
    ...
    public override void OnInitialized()
    {
        ...
        Harmony.CreateAndPatchAll(typeof(MyModPlugin).Assembly);
    ...
    {
        GUILayout.Label("MyModName - Some description");
